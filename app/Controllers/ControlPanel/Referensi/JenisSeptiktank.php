...
namespace App\Controllers\ControlPanel\Referensi;

use App\Controllers\BaseController;
use App\Models\ControlPanel\Referensi\JenisSeptiktank as Model;
use App\Validation\ControlPanel\Referensi\JenisSeptiktank as Validate;

class JenisSeptiktank extends BaseController
{

   public function index()
   {
      $this->data = [
         'title' => 'Jenis Septiktank'
      ];
